    ...
    if (count($result) > 0) {
      ...
      */
      ...
      foreach ($list as $t) {
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('T' . $rowCount, $t->total_biaya_perbaikan);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('T' . $rowCount)->getNumberFormat()->setFormatCode('#,##0');
