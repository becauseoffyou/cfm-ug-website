                               ...
                               <br>
                                ...
                                <br>
                                   <b>
                                    ...
                                    <br>
                                    <p style='color:green;'>
                                       Rp. <?php echo number_format($t->total_perbaikan); ?>
...
<?php } ?>
 ...
 foreach ($doc as $key => $d) { ?>
	...
	<img  src="<?php if (file_exists('Doc/incident/'.$d->foto.'')) { echo base_url('Doc/incident/'.$d->foto.'');}else{echo base_url('images/logo/no_image.png');} ?>" onclick="onClick(this)" data-toggle="modal" style="width:50px; height:50px; margin:5px;" data-target="#myModal"> 
 ...
 foreach ($biaya as $key => $b) { ?>
                    ...
                    data-id ="<?php echo $b->id;?>"
                     data-toggle="modal" data-target="#delete_biaya" data-rel="tooltip" title="Cancel" ><i class="fas fa-times" style="color:red; margin:10px;"></i></a>
