...
<div class="form-group">
<label for="exampleFormControlInput1">Area</label>
 <select  class="form-control" name="id_area_edit" id="id_area_edit"  required>
        <option Value="">Pilih</option>
        <?php
        foreach($area as $lok)
            { 
...
<div class="form-group">
<label for="exampleFormControlInput1">Unit</label>
 <select  class="form-control" name="id_unit_edit" id="id_unit_edit" required>
        <option Value="">Pilih</option>
...
<div class="form-group">
   <label for="exampleFormControlInput1">Petugas 1</label>
  <select class='form-control' name='participan_edit1' id='participan_edit1'>
  <option value="">Pilih</option>
<?php foreach($pic as $p) { ?>
...
<div class="form-group">
   <label for="exampleFormControlInput1">Petugas 2</label>
  <select class='form-control' name='participan_edit2' id='participan_edit2'>
      <option value="">Pilih</option>
<?php foreach($pic as $p) { ?>
        ...
        var modal = $(this)
          ...
          modal.find('#task_name_edit').text(div.data('job_detail'));
            modal.find('#task_remarks_edit').text(div.data('note'));
              modal.find("#participan_edit1 option:selected").attr("value",div.data('pic1')).text(div.data('name_pic1'));
               modal.find("#participan_edit2 option:selected").attr("value",div.data('pic2')).text(div.data('name_pic2'));
                 modal.find("#id_area_edit option:selected").attr("value",div.data('id_area')).text(div.data('id_arean'));
                   modal.find("#id_unit_edit option:selected").attr("value",div.data('id_unit')).text(div.data('id_unitn'));
                     modal.find("#type_edit option:selected").attr("value",div.data('type_problem')).text(div.data('typen'));
...
$(document).ready(function(e){
  ...
  $('#ab').DataTable({
     ...
     "ordering":false,
     "ajax":{
          url :  base_url+'Helpdesk/List_data',
              type : 'POST',
              deferLoading:57
            },
  }); // End of DataTable
...
<script>
$("#id_area_edit").change(function(){
var area = $("#id_area_edit").val();
//alert(area)
