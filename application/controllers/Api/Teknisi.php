...
class Teknisi extends CI_Controller
{
  ...
  public function List_incident()
  {
    ...
    if ($c != 'itbs_v1') {
      ...
      $dt = $this->db->query("SELECT A.*,B.desc_status as stat,C.blok,C.no_unit,C.nama_unit as nama_lokasi
 ...
 ");
  ...
  public function Finish()
  {
    ...
    if ($itbs != 'itbs_v1') {
      ...
      $this->db->set('finish_date', date('Y-m-d H:i:s'));
 ...
 ");
  ...
  public function Signature()
  {
    ...
    $b = isset($_POST['rating']) ? $_POST['rating'] : '0';
 ...
 ");
  ...
  public function List_tipe_insiden()
  {
    $js = file_get_contents('php://input');
    $json = json_decode($js, true);
    //$a = isset($json['user']) ? $json['user'] : '';
    ...
    if ($c != 'itbs_v1') {
      ...
      $dt = $this->db->query('SELECT id, type from type_incident');
      $dt_ = $dt->result();
      if (!empty($dt_)) {
        $res['data'] = $dt_;
        $res['status'] = '1';
